...
from web_core_reference.util import gpus, tools
from web_core_reference.configure.config import logger, ROOT_DIR, defaulelang
    ...
    try:
        ...
        if model_name == 'iic/SenseVoiceSmall':
            ...
            model = AutoModel(
                ...
                disable_log=True,
                trust_remote_code=True,
                remote_code=f"{ROOT_DIR}/web_core_reference/codes/model.py",
                hub='ms',
            )
