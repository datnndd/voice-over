...
from web_core_reference.task.dubbing import DubbingSrt
from web_core_reference.task.speech2text import SpeechToText
from web_core_reference.task.taskcfg import TaskCfgSTS, TaskCfgSTT, TaskCfgTTS, TaskCfgVTT
from web_core_reference.task.trans_create import TransCreate
from web_core_reference.task.translate_srt import TranslateSrt
