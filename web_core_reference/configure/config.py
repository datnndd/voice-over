...
from web_core_reference.configure.contants import (
...
def _get_langjson_list():
    lang_dir = Path(f'{ROOT_DIR}/web_core_reference/language')
    _SUPPORT_LANG={}
    if lang_dir.exists():
...
class AppSettings:
    ...
    _json_path: str = f"{ROOT_DIR}/web_core_reference/cfg.json"
...
class AppParams:
    ...
    """
    _json_path: str = f"{ROOT_DIR}/web_core_reference/params.json"
