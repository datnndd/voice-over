...
from web_core_reference.configure.excepts import NO_RETRY_EXCEPT, StopRetry
from web_core_reference.configure.config import tr, params, settings,  logger, ROOT_DIR
from web_core_reference.recognition._base import BaseRecogn
from web_core_reference.task.taskcfg import SrtItem
...
def _get_camb_lang_id(langcode):
    ...
    cache_file = Path(ROOT_DIR + '/web_core_reference/voicejson/camb_languages.json')
...
class CambRecogn(BaseRecogn):
    ...
    def _exec(self) -> Union[List[SrtItem], None]:
        ...
        if not lang_id:
            ...
            from web_core_reference.translator._camb import refresh_camb_languages
