...
from web_core_reference.configure.excepts import NO_RETRY_EXCEPT, StopRetry, SpeechToTextError
from web_core_reference.configure.config import params, logger, ROOT_DIR, settings
...
class GeminiRecogn(BaseRecogn):
    ...
    def _exec(self)->Union[List[SrtItem], None]:
        ...
        prompt = Path(ROOT_DIR+'/web_core_reference/prompts/recogn/gemini_recogn.txt').read_text(encoding='utf-8')
        # 保存说话人
        speaker_list=[]
