...
from web_core_reference.configure.config import tr, settings, logger
from web_core_reference.configure import config
from web_core_reference.configure.base import BaseCon
...
from web_core_reference.process.vad import get_speech_timestamp, get_speech_timestamp_silero
