...
from web_core_reference.configure.config import params,settings,logger
from web_core_reference.configure.excepts import NO_RETRY_EXCEPT, SpeechToTextError
