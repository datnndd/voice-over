...
from web_core_reference.configure.config import  settings, ROOT_DIR
...
from web_core_reference.process import openai_whisper, faster_whisper
from web_core_reference.configure.contants import FASTER_MODELS_DICT
