...
from web_core_reference.configure import contants
from web_core_reference.configure.config import ROOT_DIR, tr, settings, logger, HOME_DIR
from web_core_reference.configure import config
from web_core_reference.configure.excepts import SpeechToTextError
from web_core_reference.recognition import run
from web_core_reference.task._base import BaseTask
from web_core_reference.task.taskcfg import TaskCfgSTT
...
class SpeechToText(BaseTask):
    ...
    def recogn(self):
        ...
        if self.cfg.remove_noise:
            ...
            from web_core_reference.process.prepare_audio import vocal_bgm_spleeter
            kw = {
