...
from web_core_reference.configure.config import settings, params,  logger, ROOT_DIR
from web_core_reference.configure.excepts import NO_RETRY_EXCEPT, StopTask
from web_core_reference.tts._base import BaseTTS
...
class AI302(BaseTTS):
    ...
    def __post_init__(self):
        ...
        with open(ROOT_DIR + "/web_core_reference/voicejson/302.json", 'r', encoding='utf-8') as f:
