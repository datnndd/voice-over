...
from web_core_reference.configure.config import ROOT_DIR, app_cfg, logger
    ...
    def _download(self):
        if not Path(f'{ROOT_DIR}/models/vits/zh_en/model.onnx').exists():
            tools.down_zip(f"{ROOT_DIR}/models",
                           'https://modelscope.cn/models/himyworld/web_core_reference/resolve/master/vits-tts.zip',
