...
from app_core.configure.config import tr, settings, app_cfg, logger, push_queue, TEMP_ROOT
from app_core.configure.excepts import app_coreError
from app_core.process.signelobj import GlobalProcessManager
from app_core.task.taskcfg import SignMsg
from app_core.util import tools
from app_core.util.gpus import get_cudaX
...
class BaseCon:
    ...
    def _new_process(self, callback=None, title="", is_cuda=False, kwargs=None):
        ...
        try:
            ...
            raise app_coreError(f'{_model}{_cuda} {e}')
