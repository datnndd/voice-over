...
from app_core.configure.config import ROOT_DIR, tr, settings, logger, HOME_DIR
from app_core.configure import config
from app_core.configure.excepts import SpeechToTextError
from app_core.recognition import run
from app_core.task._base import BaseTask
from app_core.task.taskcfg import TaskCfgSTT
...
class SpeechToText(BaseTask):
    ...
    def recogn(self):
        ...
        if self.cfg.remove_noise:
            ...
            from app_core.process.prepare_audio import vocal_bgm_spleeter
            kw = {
