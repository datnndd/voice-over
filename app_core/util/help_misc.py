...
from app_core import VERSION
from app_core.configure.config import tr, app_cfg, logger, ROOT_DIR, defaulelang, push_queue
import tqdm
...
def open_url(url: str = None):
    import webbrowser
    title_url_dict = {
        'bbs': "https://bbs.pyapp_core.com",
        'ffmpeg': "https://www.ffmpeg.org/download.html",
        'git': "https://github.com/jianchang512/pyapp_core",
        'issue': "https://github.com/jianchang512/pyapp_core/issues",
        'hfmirrorcom': "https://pyapp_core.com/819",
        'models': "https://github.com/jianchang512/stt/releases/tag/0.0",
        'stt': "https://github.com/jianchang512/stt/",

        'gtrans': "https://pyapp_core.com/aiocr",
        'cuda': "https://pyapp_core.com/gpu.html",
        'website': "https://pyapp_core.com",
        'help': "https://pyapp_core.com",
        'xinshou': "https://pyapp_core.com/getstart",
        "about": "https://pyapp_core.com/about",
        'download': "https://github.com/jianchang512/pyapp_core/releases",
    }
...
def get_prompt(ainame, aisendsrt=True):
    ...
    glossary = ''
    if Path(ROOT_DIR + '/app_core/glossary.txt').exists():
        glossary = Path(ROOT_DIR + '/app_core/glossary.txt').read_text(encoding='utf-8-sig', errors="ignore").strip()
        if glossary:
...
def get_prompt_file(ainame, aisendsrt=True):
    prompt_path = f'{ROOT_DIR}/app_core/'
...
def check_new_version():
    ...
    try:
        ...
        url = f"https://pyapp_core.com/version.json?version={VERSION}&os={sys.platform}"
